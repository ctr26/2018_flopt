...
\begin{abstract}
 ...
 Here we present an open-hardware sample mounting system for light-sheet microscopes using large detection objectives, built using 3D printed components and demonstrate the chamber's efficacy on live biological samples in a custom light-sheet microscope. %R1C1 + R1C2
...
\begin{keywords}
 light-sheet microscopy, sample mounting, volumetric imaging, organismal imaging, cell imaging
\end{keywords}
